...
int Warrior :: receiveDamagePhys(int damageBase) 
{
    if (dodgeCalculator() == 1) 
    return 0;

    float damage = damageBase;

    float effectiveDamage2 = damage - (damage * (  (float) (this->armor / 2)  / (100.0) )); 
...
int Warrior :: receiveDamageMag(int damageBase) 
    ...
    float effectiveDamage2 = damage - (damage * (  (float) (this->magicalResistance / 2)  / (100.0) )); 
...
int Warrior :: physicalDamageCalculator () 
{
    ...
    cout<<"\n\n-+-+-+- ESSA DOEU! DANO DE "<<damage<<" FEITO -+-+-+-\n\n";
...
int Warrior :: magicalDamageCalculator (int escolha)
{
...
int Warrior :: showMagicMenu(ICharacter *p2)
{
...
int Paladin :: receiveDamagePhys(int damageBase) 
{
    if (dodgeCalculator() == 1) 
    return 0;
...
int Paladin :: receiveDamageMag(int damageBase) 
{
    if (dodgeCalculator() == 1) 
    return 0;
...
int Paladin :: physicalDamageCalculator () 
{
    int damage = (rand() % 200) + 1;
...
int Paladin :: magicalDamageCalculator (int escolha) 
{
    int damage = magic->baseMagicDamage(escolha);
...
int Paladin :: showMagicMenu(ICharacter *p2) 
{
